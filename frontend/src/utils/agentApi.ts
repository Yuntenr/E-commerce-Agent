...
export async function streamQuery(query: string, user_id: number, session_id: string | null, options: QueryOptions) {
    const response = await fetch(`${API_BASE_URL}/E-commerce/query`, {
        method: "POST",
        headers: {
